...
const CACHE_VERSION = 'minetris-v7.5.4';
...
const STATIC_ASSETS = [
  ...
  './js/core/block-physics.js',
  './js/core/inventory.js',
  './js/core/savestate.js',
  './js/core/replay.js',
  './js/core/ghost-replay.js',
  './js/core/finesse.js',
  ...
  './js/rendering/parallax-background.js',
  './js/rendering/sky.js',
  './js/rendering/postprocessing.js',
  './js/rendering/aura.js',
  './js/rendering/trails.js',
  './js/rendering/weather.js',
  './js/rendering/block-skin-anim.js',
  ...
  './js/progression/xp-season-pass.js',
  ...
  './js/ui/game-over-sequence.js',
  './js/ui/game-tooltips.js',
  './js/ui/score-card.js',
  './js/ui/input-display.js',
  './js/ui/achievement-showcase.js',
  './js/ui/puzzle-library.js',
  './js/ui/credits.js',
  './js/ui/editor.js',
