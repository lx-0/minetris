...
| **Mining-driven line-clear feedback** | P0 ✅ | When you mine the block that completes a line, the clear feels 3x more dramatic: bigger explosion, screen shake, bonus score multiplier. The game rewards *you* for the clear, not gravity. Shipped: 3× fragments, 0.40 s shake, amber flash, 1.5× score, distinct SFX, banner suffix. (MINAA-835) | Makes the player the hero of every line-clear, not a spectator |
