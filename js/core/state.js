...
let blocksMined = 0;
let linesCleared = 0;
let oreMined = {};              // { "gold": 12, "diamond": 3, ... } — excludes hazards/bedrock
let minedLineClears = 0;       // line clears where _lcIsMined was true
let minedClearBonusScore = 0;  // cumulative bonus from 1.5× mined-clear multiplier
let totalItemsCrafted = 0;     // increments on every successful recipe execution
let miningScore = 0;           // running total of points awarded from block mining
let lineClearScore = 0;        // running total of points awarded from line clears
